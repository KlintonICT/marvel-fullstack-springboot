(() => {
  ...
  function selectHero(hero) {
     ...
     */
    // formElem['name'].setAttribute('value', hero.name);
    // formElem['superpower'].setAttribute('value', hero.superpower);
    formElem.name.value = hero.name;
    formElem.superpower.value = hero.superpower;
    selectedHero = hero;
    showForm(true);
  }
  ...
  function displayHeroes(heroes) {
     ...
     */
    heroes.forEach(hero => {
      const tempHero = createHeroElement(hero);
      heroesElem.appendChild(tempHero);
    })
  }
